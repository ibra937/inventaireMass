...
document.getElementById('moreInto').addEventListener('click', () => {
    cloneElement('blockInto', 'into');
});

document.getElementById('moreOuta').addEventListener('click', () => {
    cloneElement('blockOuta', 'outa');
});

document.addEventListener("DOMContentLoaded", function() {
    // Recrée les clones pour chaque groupe si le compteur est supérieur à 1
    rehydrateClones('into', 'blockInto');
    rehydrateClones('outa', 'blockOuta');
